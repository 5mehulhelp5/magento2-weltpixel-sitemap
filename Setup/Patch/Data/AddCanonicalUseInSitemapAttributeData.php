...
class AddCanonicalUseInSitemapAttributeData implements DataPatchInterface, PatchVersionInterface
{
    ...
    public function apply()
    {
        ...
        $enableCanonicalAttribute = 'wp_use_canonical_url_in_sitemap';
